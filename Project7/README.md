...
> A production-ready authentication system with a cyberpunk-themed UI featuring JWT sessions, bcrypt password hashing, and a MongoDB backend.
...
> _Add screenshots by running the app and capturing the UI at `/auth` and `/dashboard`._
